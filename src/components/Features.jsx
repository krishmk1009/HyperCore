        ...
        <section className="bg-white dark:bg-gray-900">
            <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                <div className="mx-auto max-w-screen-sm text-center lg:mb-16 mb-8">
                    ...
                    <p className="font-light text-gray-500 sm:text-xl dark:text-gray-400">Full Stack Development Solutions: Comprehensive Solutions for Your Application & Web Development Needs.</p>
                </div>
                <div className="grid gap-8 lg:grid-cols-2">
                    <article className="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <p className="mb-5 font-light text-gray-800 dark:text-gray-400">Our full stack development services cover all aspects of web development, from front-end to back-end and everything in between. We specialize in delivering custom-built full stack solutions that meet the unique needs of your business.</p>
                        <div className="flex justify-between items-center">
                            ...
                            <a href="mailto:krushnamk1009@gmail.com" className="inline-flex items-center font-medium text-orange-600 dark:text-primary-500 hover:underline">
                                Mail us
                    ...
                    <article className="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <p className="mb-5 font-light text-gray-800 dark:text-gray-400">With expertise in WordPress, our team can help you create custom-built solutions,our solutions are designed to be scalable, secure, and user-friendly, delivering the perfect solution for your business needs.</p>
                        <div className="flex justify-between items-center">
                            <div className="flex items-center space-x-4">
